...
async def test_llm_chat_with_subscription_check(
    ...
    # Create user
    user_data = {"email": "llmuser@example.com", "password": "testpassword123"}
    ...
    mock_response = {
        "choices": [
            {"message": {"content": "Hello! This is a test response from the LLM."}}
        ]
    }
...
async def test_llm_usage_limit_exceeded(
    ...
    # Create user
    user_data = {"email": "llmlimit@example.com", "password": "testpassword123"}
...
async def test_llm_chat_user_isolation(
    ...
    # Create two users
    user1_data = {"email": "llmuser1@example.com", "password": "testpassword123"}
    ...
    # Mock OpenRouter API
    mock_response = {"choices": [{"message": {"content": "Response for user"}}]}
...
async def test_llm_chat_requires_authentication(client: AsyncClient, respx_mock):
    ...
    chat_data = {"user_id": 1, "message": "Test message"}
...
async def test_llm_chat_user_validation(client: AsyncClient, respx_mock):
    ...
    # Create two users
    user1_data = {"email": "llmval1@example.com", "password": "testpassword123"}
    user2_data = {"email": "llmval2@example.com", "password": "testpassword123"}
